...
public class HardcodedData {
    public static List<Show> createSampleShows() {
        ...
        Show show7 = new ShowBuilder().setMovie(m7).setTheater(new Theater("Hall G")).setTime("17:00").setSeatLayout(5,4).setPrice(9.5).build();
        Show show8 = new ShowBuilder().setMovie(m8).setTheater(new Theater("Hall H")).setTime("22:30").setSeatLayout(6,4).setPrice(10.5).build();
